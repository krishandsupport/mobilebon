<?php
    $apiUrl = "http://192.168.194.50:3000/suppliers";
    ...
    // Cek user permission untuk menu supplier
    $useraktif=$_SESSION['username'];
    $menuname='form_supplier';
        ...
        foreach ($permissions as $permission) {
            ...
            if ($permission->is_open == 0) {
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'GET' && !isset($_GET['delete'])) {
                    ...
                    $suppliers = json_decode(file_get_contents($url, false, $context));
                }
            }
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['insert'])) {
                ...
                if ($permission->is_addnew == 0) {
                    ...
                    echo "window.location.href = '?page=supplier';";
                    echo "</script>";
                    exit();
                }
                ...
                $data = array(
                    ...
                    "al_supplier" => $_POST['al_supplier'],
                    "tl_supplier" => $_POST['tl_supplier'],
                ...
                $context = stream_context_create($options);
                $suppliers=json_decode(file_get_contents($apiUrl, false, $context));
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
                ...
                $context  = stream_context_create($options);
                $suppliers = json_decode(file_get_contents($apiUrl . '/' . $id, false, $context));
                header("Location: ?page=supplier");
            }
...
<style>
    @media only screen and (max-width: 768px) {
        ...
        .styled-table thead tr th:nth-child(2) {
            left: 25px; /* geser sesuai dengan lebar kolom pertama */
        }

        .styled-table thead tr th:nth-child(3) {
            left: 25px; /* geser sesuai dengan lebar kolom pertama dan kedua */
        }
...
<section id="supplier">
    <div class="header fixed-top">
        ...
        <div class="right">
            ...
            <a href="?page=supplier"><img src="assets/images/arrow-clockwise.svg" alt="Hapus"></a>
        </div>
    </div>
        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td label="Kode"><?php echo $supplier->kd_supplier; ?></td>
                    <td label="Nama Supplier"><?php echo $supplier->nm_supplier; ?></td>
                    <td label="Alamat"><?php echo $supplier->al_supplier; ?></td>
                    <td label="Telp"><a href="whatsapp://send?phone=<?php echo $supplier->tl_supplier; ?>" target="_blank"><?php echo $supplier->tl_supplier; ?></a></td>
                    <td label="Kontak"><?php echo $supplier->pi_supplier; ?></td>
                    <td label="Perintah" style="width:80px;">
                        <!-- Update Link -->
                        <a class="btn btn-basic btn-sm" 
                            data-id_supplier="<?php echo $supplier->id_supplier; ?>" 
                            data-kd_supplier="<?php echo $supplier->kd_supplier; ?>" 
                            data-nm_supplier="<?php echo $supplier->nm_supplier; ?>" 
                            data-al_supplier="<?php echo $supplier->al_supplier; ?>" 
                            data-tl_supplier="<?php echo $supplier->tl_supplier; ?>" 
                            data-pi_supplier="<?php echo $supplier->pi_supplier; ?>" 
                            onclick="
                                $('#EditModal').modal('show');
                                $('#edit-id_supplier').val($(this).data('id_supplier'));
                                $('#edit-kd_supplier').val($(this).data('kd_supplier'));
                                $('#edit-nm_supplier').val($(this).data('nm_supplier'));
                                $('#edit-al_supplier').val($(this).data('al_supplier'));
                                $('#edit-tl_supplier').val($(this).data('tl_supplier'));
                                $('#edit-pi_supplier').val($(this).data('pi_supplier'));">
                        ...
                        <!-- Delete Link --> 
                        <a class="btn btn-basic btn-sm" href="?page=supplier&delete=<?php echo $supplier->id_supplier; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data <?php echo $supplier->nm_supplier; ?> ini?');">
            ...
            <div class="modal-content">
                <form method="POST" style="display:inline-block;">
                    <div class="modal-header">
                        <h6 class="modal-title" id="addModalLabel">Tambah supplier</h6>
                    ...
                    <div class="modal-body">
                        ...
                        <!--<div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kd_supplier" name="kd_supplier" placeholder="Kode Supplier" required>
                        </div>-->
                        ...
                        <div class="form-floating mt-1 mb-2">
                            <input type="text" class="form-control" id="al_supplier" name="al_supplier" placeholder="Alamat Supplier" required>
                            <label for="nm_supplier">Alamat supplier</label>
                        </div>
                        <div class="form-floating mt-1 mb-2">
                            <input type="text" class="form-control" id="tl_supplier" name="tl_supplier" placeholder="Telp Supplier" required>
                            <label for="nm_supplier">Telephone</label>
                        </div>
                        <div class="form-floating mt-1 mb-1">
                            <input type="text" class="form-control" id="pi_supplier" name="pi_supplier" placeholder="Kontak Supplier" required>
                            <label for="nm_supplier">Kontak Person</label>
                        </div>
                    </div>
    ...
    <div id="EditModal" class="modal fade" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" style="display:inline-block;">
                    <div class="modal-header">
                        <h6 class="modal-title" id="addModalLabel">Edit Supplier</h6>
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" class="form-control" id="edit-id_supplier" name="id_supplier" placeholder="ID supplier" required>
                        <!--<input type="hidden" name="_method" value="PUT"> Ini sinyal untuk update -->
                        <div class="form-floating mt-1 mb-1">
                            <input type="text" class="form-control" id="edit-kd_supplier" name="kd_supplier" placeholder="Kode supplier" required>
                            <label for="kd_supplier">Kode</label>
                        </div>
                        <div class="form-floating mt-1 mb-2">
                            <input type="text" class="form-control" id="edit-nm_supplier" name="nm_supplier" placeholder="Nama supplier" required>
                            <label for="nm_supplier">Nama supplier</label>
                        </div>
                        <div class="form-floating mt-1 mb-2">
                            <input type="text" class="form-control" id="edit-al_supplier" name="al_supplier" placeholder="Alamat Supplier" required>
                            <label for="nm_supplier">Alamat supplier</label>
                        </div>
                        <div class="form-floating mt-1 mb-2">
                            <input type="text" class="form-control" id="edit-tl_supplier" name="tl_supplier" placeholder="Telp Supplier" required>
                            <label for="nm_supplier">Telephone</label>
                        </div>
                        <div class="form-floating mt-1 mb-1">
                            <input type="text" class="form-control" id="edit-pi_supplier" name="pi_supplier" placeholder="Kontak Supplier" required>
                            <label for="nm_supplier">Kontak Person</label>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div id="CariModal" class="modal fade" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" style="display:inline-block;">
                    <div class="modal-header">
                        <h6 class="modal-title" id="addModalLabel">Cari Supplier</h6>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
