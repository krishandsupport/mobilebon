<?php
    $apiUrl = "http://192.168.194.50:3000/satuans";
        ...
        foreach ($permissions as $permission) {
            ...
            if ($permission->is_open == 0) {
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'GET' && !isset($_GET['delete'])) {
                    ...
                    $satuans = json_decode(file_get_contents($url, false, $context));
                }
            }
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['insert'])) {
                ...
                if ($permission->is_addnew == 0) {
                    ...
                    echo "window.location.href = '?page=satuan';";
                    echo "</script>";
                    exit();
                }
                ...
                $context = stream_context_create($options);
                $satuans=json_decode(file_get_contents($apiUrl, false, $context));
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
                ...
                $context  = stream_context_create($options);
                $satuans = json_decode(file_get_contents($apiUrl . '/' . $id, false, $context));
                header("Location: ?page=satuan");
            }
...
<section id="satuan">
    <div class="header fixed-top">
        ...
        <div class="right">
            ...
            <a href="?page=satuan"><img src="assets/images/arrow-clockwise.svg" alt="Hapus"></a>
        </div>
    </div>
        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td label="Kode"><?php echo $satuan->kd_satuan; ?></td>
                    <td label="satuan"><?php echo $satuan->nm_satuan; ?></td>
                    <td label="Perintah" style="width:80px;">
                        <!-- Update Link -->
                        <a class="btn btn-basic btn-sm" 
                            data-id_satuan="<?php echo $satuan->id_satuan; ?>" 
                            data-kd_satuan="<?php echo $satuan->kd_satuan; ?>" 
                            data-nm_satuan="<?php echo $satuan->nm_satuan; ?>" 
                            onclick="
                                $('#EditModal').modal('show');
                                $('#edit-id_satuan').val($(this).data('id_satuan'));
                                $('#edit-kd_satuan').val($(this).data('kd_satuan'));
                                $('#edit-nm_satuan').val($(this).data('nm_satuan'));">
                        ...
                        <!-- Delete Link --> 
                        <a class="btn btn-basic btn-sm" href="?page=satuan&delete=<?php echo $satuan->id_satuan; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data <?php echo $satuan->nm_satuan; ?> ini?');">
            ...
            <div class="modal-content">
                <form method="POST" style="display:inline-block;">
                    <div class="modal-header">
                        <h6 class="modal-title" id="addModalLabel">Tambah Satuan</h6>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-floating mt-1 mb-2">
                            <input type="text" class="form-control" id="kd_satuan" name="kd_satuan" placeholder="Kode satuan" required>
                            <label for="kd_satuan">Kode</label>
                        </div>
                        <div class="form-floating mt-1 mb-1">
                            <input type="text" class="form-control" id="nm_satuan" name="nm_satuan" placeholder="Nama satuan" required>
    ...
    <div id="EditModal" class="modal fade" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" style="display:inline-block;">
                    <div class="modal-header">
                        <h6 class="modal-title" id="addModalLabel">Edit Satuan</h6>
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" class="form-control" id="edit-id_satuan" name="id_satuan" placeholder="ID satuan" required>
                        <!--<input type="hidden" name="_method" value="PUT"> Ini sinyal untuk update -->
                        <div class="form-floating mt-1 mb-2">
                            <input type="text" class="form-control" id="edit-kd_satuan" name="kd_satuan" placeholder="Kode satuan" required>
                            <label for="kd_satuan">Kode</label>
                        </div>
                        <div class="form-floating mt-1 mb-1">
                            <input type="text" class="form-control" id="edit-nm_satuan" name="nm_satuan" placeholder="Nama satuan" required>
                            <label for="nm_satuan">Nama Satuan</label>
                        </div>
                    </div>
                    <div class="modal-footer">
