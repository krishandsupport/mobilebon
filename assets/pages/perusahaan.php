<?php
    $apiUrl = "http://192.168.194.50:3000/perusahaans";
    ...
    // Cek user permission untuk menu perusahaan
    $useraktif=$_SESSION['username'];
    $menuname='form_perusahaan';
        ...
        foreach ($permissions as $permission) {
            ...
            if ($permission->is_open == 0) {
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'GET' && !isset($_GET['delete'])) {
                    ...
                    $perusahaans = json_decode(file_get_contents($url, false, $context));
                }
            }
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['insert'])) {
                ...
                if ($permission->is_addnew == 0) {
                    ...
                    echo "window.location.href = '?page=perusahaan';";
                    echo "</script>";
                    exit();
                }
                ...
                $context = stream_context_create($options);
                $perusahaans=json_decode(file_get_contents($apiUrl, false, $context));
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
                ...
                $context  = stream_context_create($options);
                $perusahaans = json_decode(file_get_contents($apiUrl . '/' . $id, false, $context));
                header("Location: ?page=perusahaan");
            }
...
<section id="perusahaan">
    <div class="header fixed-top">
        ...
        <div class="right">
            ...
            <a href="?page=perusahaan"><img src="assets/images/arrow-clockwise.svg" alt="Hapus"></a>
        </div>
    </div>
        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td label="Kode"><?php echo $perusahaan->kd_perusahaan; ?></td>
                    <td label="Perusahaan"><?php echo $perusahaan->nm_perusahaan; ?></td>
                    <td label="Perintah" style="width:80px;">
                        <!-- Update Link -->
                        <a class="btn btn-basic btn-sm" data-id_perusahaan="<?php echo $perusahaan->id_perusahaan; ?>" data-kd_perusahaan="<?php echo $perusahaan->kd_perusahaan; ?>" data-nm_perusahaan="<?php echo $perusahaan->nm_perusahaan; ?>" onclick="$('#EditModal').modal('show');$('#edit-id_perusahaan').val($(this).data('id_perusahaan'));$('#edit-kd_perusahaan').val($(this).data('kd_perusahaan'));$('#edit-nm_perusahaan').val($(this).data('nm_perusahaan'));">
                        ...
                        <!-- Delete Link --> 
                        <a class="btn btn-basic btn-sm" href="?page=perusahaan&delete=<?php echo $perusahaan->id_perusahaan; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data <?php echo $perusahaan->nm_perusahaan; ?> ini?');">
            ...
            <div class="modal-content">
                <form method="POST" style="display:inline-block;">
                    <div class="modal-header">
                        <h6 class="modal-title" id="addModalLabel">Tambah Perusahaan</h6>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-floating mt-1 mb-2">
                            <input type="text" class="form-control" id="kd_perusahaan" name="kd_perusahaan" placeholder="Kode Perusahaan" required>
                            <label for="kd_perusahaan">Kode</label>
                        </div>
                        <div class="form-floating mt-1 mb-1">
                            <input type="text" class="form-control" id="nm_perusahaan" name="nm_perusahaan" placeholder="Nama Perusahaan" required>
    ...
    <div id="EditModal" class="modal fade" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" style="display:inline-block;">
                    <div class="modal-header">
                        <h6 class="modal-title" id="addModalLabel">Edit Perusahaan</h6>
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" class="form-control" id="edit-id_perusahaan" name="id_perusahaan" placeholder="ID Perusahaan" required>
                        <!--<input type="hidden" name="_method" value="PUT"> Ini sinyal untuk update -->
                        <div class="form-floating mt-1 mb-2">
                            <input type="text" class="form-control" id="edit-kd_perusahaan" name="kd_perusahaan" placeholder="Kode Perusahaan" required>
                            <label for="kd_perusahaan">Kode</label>
                        </div>
                        <div class="form-floating mt-1 mb-1">
                            <input type="text" class="form-control" id="edit-nm_perusahaan" name="nm_perusahaan" placeholder="Nama Perusahaan" required>
                            <label for="nm_perusahaan">Nama Perusahaan</label>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div id="CariModal" class="modal fade" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" style="display:inline-block;">
                    <div class="modal-header">
                        <h6 class="modal-title" id="addModalLabel">Cari Perusahaan</h6>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
